...
| Columns | [ColumnDefinitions](../Types/ColumnDefinitions) | Column definitions that determines the proportional or pixel size of each column in the grid as well as their min/max size. |
| ColumnSpacing | [ElementSize](../Types/ElementSize) | Spacing between grid columns. |
...
| Rows | [RowDefinitions](../Types/RowDefinitions) | Row definitions that determines the proportional or pixel size of each row in the grid as well as their min/max size. |
| RowSpacing | [ElementSize](../Types/ElementSize) | Spacing between grid rows. |
| Scale | [Vector3](http://docs.unity3d.com/ScriptReference/Vector3.html) | Scale of the view. |
| Spacing | [ElementSize](../Types/ElementSize) | Spacing between grid row and columns. |
