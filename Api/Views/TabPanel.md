...
| SelectedTabIndex | int | Selected tab index. |
| TabHeaderHeight | [ElementSize](../Types/ElementSize) | Default height of tab headers. |
| TabHeaderWidth | [ElementSize](../Types/ElementSize) | Default width of tab headers. |
| TabSwitchMode | [SwitchMode](../Types/SwitchMode) | Enum indicating view switch mode, e.g. if tabs should be loaded on-demand or be pre-loaded. |
