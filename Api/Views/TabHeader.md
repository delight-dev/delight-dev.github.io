...
| AutoSize | [AutoSize](../Types/AutoSize) | Enum indicating if and how the button should automatically resize itself to the size of the text. |
...
| CanToggleOff | bool | Boolean indicating if the button can be toggled off. |
| CanToggleOn | bool | Boolean indicating if the button can be toggled on. |
...
| IsBackButton | bool | Boolean indicating if this is a back button. |
| IsCloseButton | bool | Boolean indicating if this is a close button. |
| IsDisabled | bool | Boolean indicating if this button is disabled. |
| IsMouseOver | bool | Boolean indicating if the mouse is over the button. |
...
| TabIndex | int | Index of the tab. |
| TextOffset | [ElementMargin](../Types/ElementMargin) | The offset of the button text label. |
| TextPadding | [ElementMargin](../Types/ElementMargin) | Padding applied when the button autosizes to its content. |
| ToggleValue | bool | Toggle value of the button. |
