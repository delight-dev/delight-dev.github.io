...
| IsChecked | bool | Boolean indicating if the radio button is selected. |
| IsDisabled | bool | Boolean indicating if the radio button is disabled. |
| IsInteractable | bool | Boolean indicating if the user can toggle the radio button. |
...
| Spacing | [ElementSize](../Types/ElementSize) | The spacing between the radio button image and the label. |
