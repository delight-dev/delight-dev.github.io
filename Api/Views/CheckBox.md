...
| IsChecked | bool | Boolean indicating if the check box is checked. |
| IsDisabled | bool | Boolean indicating if the check box is disabled. |
| IsInteractable | bool | Boolean indicating if the user can interact with the check box. |
...
| Spacing | [ElementSize](../Types/ElementSize) | Spacing between the check box sprite and the text label. |
