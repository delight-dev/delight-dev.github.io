...
| NavigationType | [NavigationButtonType](../Types/NavigationButtonType) | Type of navigation button this button represents. |
...
| PageIndex | int | Set programmatically to keep track of which page this button navigates to. |
