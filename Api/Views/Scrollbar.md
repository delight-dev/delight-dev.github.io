...
| Breadth | [ElementSize](../Types/ElementSize) | Breadth of the scrollbar. Corresponds to Height if horizontal and Width if vertical. |
...
| Length | [ElementSize](../Types/ElementSize) | Length of the scrollbar. Corresponds to Width if horizontal and Height if vertical. |
...
| Orientation | [ElementOrientation](../Types/ElementOrientation) | The orientation of the scrollbar. |
...
| ScrollPosition | float | Sets normalized scroll position (0-1 where 0.5 is scrolled half-way). |
...
| ViewportRatio | float | Value between 0-1 determining the size of the scrollbar handle relative to the viewport. |
