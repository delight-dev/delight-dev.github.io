...
We'll start by creating a simple view and break down its parts to see how it ticks. If you don't know how to create a view and display it in a scene, check out the initial steps in the [Getting Started](GettingStarted) tutorial.
